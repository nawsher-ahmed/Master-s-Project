 ...
 * C source code generated on : Wed Apr 20 13:49:13 2016
 *
...
typedef struct {
  real_T SFunction_RWORK[7];           /* '<S1>/ S-Function ' */
  struct {
    void *CircuitModel;
...
typedef struct {
  real_T SFunction_CSTATE[6];          /* '<S1>/ S-Function ' */
} X_Model2_T;
...
/* State disabled  */
typedef struct {
  boolean_T SFunction_CSTATE[6];       /* '<S1>/ S-Function ' */
} XDis_Model2_T;
...
/* External inputs (root inport signals with auto storage) */
extern ExtU_Model2_T Model2_U;

/* External outputs (root outports fed by signals with auto storage) */
extern ExtY_Model2_T Model2_Y;
